...
import 'package:nourish_now/data/auth_repository/exceptions/signup_exception.dart';
import 'package:nourish_now/modules/auth/bindings/verify_email_bindings.dart';
import 'package:nourish_now/modules/auth/models/signup_model.dart';
import 'package:nourish_now/modules/auth/views/verify_email_screen.dart';
import 'package:nourish_now/modules/layout/bindings/bindings.dart';
import 'package:nourish_now/modules/layout/views/layout.dart';
import 'package:nourish_now/modules/location/controller/location_controller.dart';
import 'package:nourish_now/modules/on_boarding/bindings/bindings.dart';
import 'package:nourish_now/modules/on_boarding/views/on_boarding.dart';
...
import 'package:nourish_now/modules/started_screen/started_screen.dart';
import 'package:nourish_now/shared/constants/constants.dart';
import 'package:nourish_now/shared/local/cache_helper.dart';
...
class AuthenticationRepository extends GetxController {
  ...
  Future<void> createUserWithEmailAndPassword(
    ...
    try {
      ...
      if (firebaseUser.value != null) {
        ...
        Get.offAll(const VerifyEmailScreen(),transition: Transition.rightToLeft,binding: VerifyEmailBindings());
      }
  ...
  Future<void> loginWithGoogle() async {
    try {
     ...
     await FirebaseFirestore.instance
         .collection('users')
         .doc(userCredential.user!.uid).get().then((value) async {
           if(!value.exists){
             await userCreate(
  ...
  Future<void> sendPasswordResetEmail(String email) async {
    try {
      ...
      Get.snackbar("'Error sending password reset email",e.toString(),colorText: Colors.red);
