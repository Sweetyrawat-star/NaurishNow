...
import 'package:nourish_now/modules/auth/bindings/login_bindings.dart';
import 'package:nourish_now/modules/auth/controllers/signup_controller.dart';
import 'package:nourish_now/modules/auth/views/login_screen.dart';
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: Dimensions.height10*2.8,),
                CustomFormField(hintText: "Mobile No",prefixIcon: Icons.phone_android,controller: controller.phone,isPhone: true,),
                SizedBox(height: Dimensions.height10*2.8,),
