...
import 'package:nourish_now/modules/profile_screen/views/widgets.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      CustomFormField(
                        ...
                        radius: 5,
                        isPhone: true,
                        hintText: controller.userModel!.phone==""?"Enter Your Phone Number":controller.userModel!.phone,
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const Spacer(),
                                  CustomButton(
                                    filledColor: controller.editingProfile?AppColors.mainColor:AppColors.greyColor,
                                    onPressed: () {
                                      if(controller.editingProfile) {
                                        Get.to(const PickAddressMap(fromProfile: true,));
                                      }
                                    },
                                    height: Dimensions.height10 * 3,
